                    ...
                    <div className="relative z-10 w-full p-6 md:p-8 transition-all duration-300">
                        ...
                        <div className="relative z-10 mb-6 text-center md:text-left">
                            <h2 className="text-2xl md:text-3xl font-black text-slate-800 tracking-tight">
                                Create <span className="bg-gradient-to-r text-blue-600">Account</span>
                            </h2>
                            <p className="text-slate-500 text-xs md:text-sm font-medium mt-1">Join our premium creator and client ecosystem</p>
                        </div>
                        ...
                        <div className="relative z-10 grid grid-cols-2 gap-3 mb-6">
                            <div 
                                ...
                                className={`p-3 rounded-2xl border transition-all duration-300 text-center backdrop-blur-sm ${
                                    step === 1 
                                        ? 'bg-white/80 border-blue-400 text-blue-700 shadow-sm font-bold' 
                                        : 'bg-white/30 border-white/20 text-slate-500 cursor-pointer hover:bg-white/50'
                                }`}
                            >
                                <div className="text-[10px] uppercase tracking-widest font-black opacity-80">01</div>
                            ...
                            >
                                <div className="text-[10px] uppercase tracking-widest font-black opacity-80">02</div>
                        ...
                        {/* ================= STEP 1 ================= */}
                        {step === 1 && (
                            <form onSubmit={submitStep1} className="relative z-10 space-y-4">
                                <div>
                                ...
                                <div>
                                    ...
                                    <select
                                        className="mt-1 block w-full rounded-xl border-white/60 bg-white/50 p-2.5 text-slate-900 shadow-inner focus:bg-white/90 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition duration-200 outline-none text-sm font-medium"
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div 
                                            ...
                                            className={`p-3 rounded-xl border cursor-pointer text-center transition-all backdrop-blur-sm ${
                                                data.role === 'client' 
                                                    ? 'bg-white/80 border-blue-500 text-blue-800 shadow-sm font-bold' 
                                                    : 'bg-white/20 border-white/40 text-slate-600 hover:bg-white/40'
                                            }`}
                                        >
                                            <span className="block text-xs md:text-sm">Client Account</span>
                                            <span className="block text-[10px] text-slate-500 mt-0.5 font-normal">I want to hire talent</span>
                                        </div>
                                        <div 
                                        ...
                                        >
                                            <span className="block text-xs md:text-sm">Freelancer</span>
                                            <span className="block text-[10px] text-slate-500 mt-0.5 font-normal">I want to apply for jobs</span>
                                        </div>
                                    </div>
